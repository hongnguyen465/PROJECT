    ...
    <>
      ...
      >
        ...
        <button
          ...
          title="Xem nhanh"
          className="absolute top-5 right-5 z-10 grid h-8 w-8 place-items-center rounded-full border border-white/10 bg-slate-950/70 text-slate-300 opacity-0 backdrop-blur-md transition-all duration-200 hover:scale-110 hover:bg-white hover:text-slate-950 group-hover:opacity-100"
        >
          <Eye size={15} />
        </button>
